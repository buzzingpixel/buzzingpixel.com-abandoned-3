...
class CreateActionQueueItemsTable extends AbstractMigration
{
    public function change() : void
    {
        $this->table('action_queue_items', [
            ...
            ->addColumn('order_to_run', 'integer', ['comment' => 'The order in which the items in this batch should run'])
            ...
            ->addColumn('class', 'text', ['comment' => 'The class that this item will use to run'])
            ->addColumn('method', 'text', ['comment' => 'The method on the class that this item will use to run'])
